...
namespace Payamito\VV\Required;
	 ...
	 */
			$plugins = array(
				array(
					...
					'required'  => true,
					'version'            => '3.4.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
				),
			...
			$config = array(
				...
				'dismiss_msg'  => __(' Plugin Payamito:vendor verification requires the installation of Dokan pro ', 'payamito-vendor-verification'),
			);
